            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    for (let i = 0; i < images.length; i++) {
                        ...
                        const img = `<a href="${imagePath}/${imageName}" download><img src="${imagePath}/${imageName}" class="upload-pp flex mx-10 my-3 img-rounded" style="width:70px; height:70px; border-radius:50%;" id="imgPreview" alt="profil"></a>`;
