    ...
    <div data-product-id="{{$product->id}}"
        ...
        <a data-product-id="{{$product->id}}" class="productInfo"
           href="{{route('productInfo', ['id' => $product->id])}}">
            ...
            <img class=" background-transparent p-8 rounded-t-lg align-content-center product-image"
...
@endforelse
<div class="pagination mt-2  sm:col-span-2 md:col-span-3 lg:col-span-4">
