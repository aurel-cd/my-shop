<x-admin-layout>
    ...
    <div class="py-4 px-4 mt-14 sm:ml-64 bg-[#61a5c2]">
        <div class="relative py-4 px-4 bg-[#a9d6e5] overflow-x-auto shadow-md sm:rounded-lg">
            <caption class=" text-lg text-left p-5 text-gray-200 dark:text-white dark:bg-gray-800">
                <h1><span class="font-bold"> Best Seller: <span> {{$best_seller->product_name}}</h1>
                <h1><span class="font-bold">Total Revenue: <span> ${{$total_revenue}}</h1>
            </caption>
        ...
        <div id="orderModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <!-- Modal header -->
                    <div class="flex items-start justify-between p-4 border-b-2 border-gray-500  rounded-t dark:border-gray-600">
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                            ORDER DETAILS
                        </h3>
                        <button type="button" class="closeModal text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="orderModal">
